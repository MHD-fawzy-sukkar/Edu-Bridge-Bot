...
async def choose_support_type(message: types.Message, state: FSMContext):
    ...
    support_prompt = (
        "📧 <b>قسم الدعم والتواصل مع فريق العمل</b>\n\n"
        "مرحباً بك! يمكنك استخدام هذا القسم لإرسال استفسارك، أو الإبلاغ عن مشكلة تقنية، \n"
        "📌 <b>تنويه بسيط:</b>\n"
        "إذا كان هدفك <u>تقديم طلب كتب جديد</u> أو <u>عرض كتب للتبرع بها</u>، يرجى عدم الكتابة هنا. "
        "اضغط على زر الإلغاء بالأسفل، ثم اختر (🛍️ تبرع بكتاب) أو (🙋‍♂️ طلب كتاب) من القائمة الرئيسية.\n\n"
        "💬 📄 <b>اكتب رسالتك بالتفصيل في رسالة واحدة</b>، وسيقوم فريق الإدارة بالرد عليك ومساعدتك في أقرب وقت ممكن.\n\n"
        "⬇️ للتراجع والعودة، اضغط على: <b>❌ إلغاء</b>"
    )
